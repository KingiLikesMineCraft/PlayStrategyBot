...
const PlayStrategyApi = require("../src/PlayStrategyApi")
...
tap.beforeEach(function (_) {
  playstrategyApi = new PlayStrategyApi(token)
  accountInfo = sinon.stubplaystrategyApi, "accountInfo")
  declineChallenge = sinon.stub(playstrategyApi, "declineChallenge")
  acceptChallenge = sinon.stub(playstrategyApi, "acceptChallenge")
  makeMove = sinon.stub(playstrategyApi, "makeMove")
  chat = sinon.stub(playstrategyApi, "chat")
  streamEvents = sinon.stub(playstrategyApi, "streamEvents")
  streamGame = sinon.stub(playstrategyApi, "streamGame")
  ...
  robotUser = new RobotUser(playstrategyApi, new RandomPlayer())
})
